...
const About = () => {
  return (
    <div
      className="flex justify-center relative text-center w-full h-[109vh] mb-0 md:mb-[1rem] md:h-[105vh] lg:h-[130vh] "
    ...
    >
      ...
      />
      <div className="relative z-10 w-full mt-[1rem]  md:w-[80%] lg:[70%]">
