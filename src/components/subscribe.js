...
const Subscribe = () => {
    return(
        <div className="bg-[#060A14] py-[2rem] font-poppins">
            <h1 className="font-orbitron text-[24px] w-full px-[1rem] text-[#F2F2F2] tracking-wide md:w-[90%] md:px-[5rem] md:text-[36px] lg:text-[48px]">Feel free to reach out to us via email to explore potential business <span className="text-[#8D1DE5]">collaborations</span> or <span className="text-[#8D1DE5]">career</span> opportunities.</h1>
            <div className="flex flex-col justify-around text-white mt-[3rem] lg:flex-row px-5 md:px-0 ">
